# -*- coding: utf-8 -*-
lesson7_code = '''import { Lesson } from '../types';
...
with open('src/data/chapter15Lesson7.ts', 'w', encoding='utf-8') as f:
  f.write(lesson7_code)

print("Created src/data/chapter15Lesson7.ts")
