# -*- coding: utf-8 -*-
lesson3_code = '''import { Lesson } from '../types';
...
with open('src/data/chapter15Lesson3.ts', 'w', encoding='utf-8') as f:
  f.write(lesson3_code)

print("Created src/data/chapter15Lesson3.ts")
