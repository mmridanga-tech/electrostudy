# -*- coding: utf-8 -*-
lesson4_code = '''import { Lesson } from '../types';
...
with open('src/data/chapter15Lesson4.ts', 'w', encoding='utf-8') as f:
  f.write(lesson4_code)

print("Created src/data/chapter15Lesson4.ts")
