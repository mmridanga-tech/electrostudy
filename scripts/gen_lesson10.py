  ...
  "formulas": [
    {
      ...
      "variables": [
        { "symbol": "n1, n2", "name": { "en": "Refractive indices n = √ε_r", "hi": "अपवर्तनांक n = √ε_r", "bn": "প্রতিসরাঙ্ক n = √ε_r" } },
        { "symbol": "θ_i", "name": { "en": "Angle of incidence", "hi": "आपतन कोण", "bn": "আপাতন কোণ" } },
        { "symbol": "θ_t", "name": { "en": "Angle of refraction (transmission)", "hi": "अपवर्तन कोण", "bn": "প্রতিসরণ কোণ" } }
      ]
    },
    {
      "id": "f-critical-angle",
      ...
      "variables": [
        { "symbol": "θ_c", "name": { "en": "Critical angle (degrees)", "hi": "क्रांतिक कोण", "bn": "সংকট কোণ" } }
      ]
    },
    {
      "id": "f-brewster-angle",
      ...
      "variables": [
        { "symbol": "θ_B", "name": { "en": "Brewster angle (degrees)", "hi": "ब्रूस्टर कोण", "bn": "ব্রূস্টার কোণ" } }
      ]
    },
    {
      ...
      "variables": [
        { "symbol": "Γ_perp", "name": { "en": "Perpendicular (TE) reflection coefficient", "hi": "लंबवत परावर्तन गुणांक", "bn": "লম্ব প্রতিফলন গুণাঙ্ক" } },
        { "symbol": "Γ_par", "name": { "en": "Parallel (TM) reflection coefficient", "hi": "समांतर परावर्तन गुणांक", "bn": "সমান্তরাল প্রতিফলন গুণাঙ্ক" } }
      ]
    }
  ],
  "sections": [
  ...
  "mcqs": [
    {
      ...
      "options": [
        { "id": "opt-1", "text": { "en": "Critical angle θ_c", "hi": "क्रांतिक कोण θ_c", "bn": "সংকট কোণ θ_c" } },
        { "id": "opt-2", "text": { "en": "Brewster angle θ_B = arctan(n2 / n1)", "hi": "ब्रूस्टर कोण θ_B = arctan(n2 / n1)", "bn": "ব্রূস্টার কোণ θ_B = arctan(n2 / n1)" } },
        { "id": "opt-3", "text": { "en": "Normal incidence (0°)", "hi": "अभिलंबवत आपतन (0°)", "bn": "লম্ব আপাতন (০°)" } },
        { "id": "opt-4", "text": { "en": "Grazing incidence (90°)", "hi": "स्पर्शीय आपतन (90°)", "bn": "স্পর্শকীয় আপাতন (৯০°)" } }
      ],
    ...
    },
    {
      ...
      "options": [
        { "id": "opt-1", "text": { "en": "θ_i = θ_t", "hi": "θ_i = θ_t", "bn": "θ_i = θ_t" } },
        { "id": "opt-2", "text": { "en": "θ_i + θ_t = 90°", "hi": "θ_i + θ_t = 90°", "bn": "θ_i + θ_t = ৯০°" } },
        { "id": "opt-3", "text": { "en": "θ_i + θ_t = 180°", "hi": "θ_i + θ_t = 180°", "bn": "θ_i + θ_t = ১৮০°" } },
        { "id": "opt-4", "text": { "en": "θ_i - θ_t = 45°", "hi": "θ_i - θ_t = 45°", "bn": "θ_i - θ_t = ৪৫°" } }
      ],
      "correctOptionId": "opt-2",
      "explanation": {
    ...
    },
    {
      ...
      "options": [
        { "id": "opt-1", "text": { "en": "n1 < n2 and θ_i < θ_c", "hi": "n1 < n2 और θ_i < θ_c", "bn": "n1 < n2 এবং θ_i < θ_c" } },
        { "id": "opt-2", "text": { "en": "n1 > n2 and θ_i > θ_c", "hi": "n1 > n2 और θ_i > θ_c", "bn": "n1 > n2 এবং θ_i > θ_c" } },
        { "id": "opt-3", "text": { "en": "n1 = n2 at any angle", "hi": "n1 = n2 किसी भी कोण पर", "bn": "যেকোনো কোণে n1 = n2" } },
        { "id": "opt-4", "text": { "en": "Only when medium 2 is a metal", "hi": "केवल तब जब माध्यम 2 धातु हो", "bn": "কেবলমাত্র ২য় মাধ্যম ধাতু হলে" } }
      ],
      "correctOptionId": "opt-2",
      "explanation": {
    ...
    },
    {
      ...
      "options": [
        { "id": "opt-1", "text": { "en": "A uniform plane wave propagating normally into Medium 2", "hi": "माध्यम 2 में सीधे आगे बढ़ने वाली समतल तरंग", "bn": "২য় মাধ্যমে লম্বভাবে সঞ্চালিত সমতল তরঙ্গ" } },
        { "id": "opt-2", "text": { "en": "An evanescent wave that decays exponentially with zero time-average power penetration", "hi": "एक अवमंदित तरंग जो चरघातांकी रूप से घटती है और शून्य समय-औसत शक्ति ले जाती है", "bn": "একটি ক্ষীয়মাণ তরঙ্গ যা সূচকীয় হারে হ্রাস পায় এবং কোনো নিট ক্ষমতা পরিবহন করে না" } },
        { "id": "opt-3", "text": { "en": "Zero electric and magnetic field everywhere in Medium 2", "hi": "माध्यम 2 में प्रत्येक स्थान पर पूर्ण शून्य क्षेत्र", "bn": "২য় মাধ্যমে তড়িৎ ও চৌম্বক ক্ষেত্র সম্পূর্ণ অনুপস্থিত" } },
        { "id": "opt-4", "text": { "en": "A circular standing wave", "hi": "वृत्तीय अप्रगामी तरंग", "bn": "বৃত্তীয় স্থির তরঙ্গ" } }
      ],
      "correctOptionId": "opt-2",
      "explanation": {
    ...
    },
    {
      ...
      "options": [
        { "id": "opt-1", "text": { "en": "30.0°", "hi": "30.0°", "bn": "৩০.০°" } },
        { "id": "opt-2", "text": { "en": "41.8°", "hi": "41.8°", "bn": "৪১.৮°" } },
        { "id": "opt-3", "text": { "en": "56.3°", "hi": "56.3°", "bn": "৫৬.৩°" } },
        { "id": "opt-4", "text": { "en": "60.0°", "hi": "60.0°", "bn": "৬০.০°" } }
      ],
      "correctOptionId": "opt-2",
      "explanation": {
    ...
    },
    {
      ...
      "options": [
        { "id": "opt-1", "text": { "en": "24.4°", "hi": "24.4°", "bn": "২৪.৪°" } },
        { "id": "opt-2", "text": { "en": "45.0°", "hi": "45.0°", "bn": "৪৫.০°" } },
        { "id": "opt-3", "text": { "en": "67.5°", "hi": "67.5°", "bn": "৬৭.৫°" } },
        { "id": "opt-4", "text": { "en": "75.2°", "hi": "75.2°", "bn": "৭৫.২°" } }
      ],
    ...
    },
    {
      ...
      "options": [
        { "id": "opt-1", "text": { "en": "Because magnetic permeability is identical across both media (μ1 = μ2 = μ0)", "hi": "क्योंकि दोनों माध्यमों की चुंबकशीलता समान होती है (μ1 = μ2 = μ0)", "bn": "কারণ উভয় মাধ্যমের চৌম্বক প্রবেশ্যতা সমান (μ1 = μ2 = μ0)" } },
        { "id": "opt-2", "text": { "en": "Because perpendicular waves travel at the speed of sound", "hi": "क्योंकि लंबवत तरंगें ध्वनि की गति से चलती हैं", "bn": "কারণ লম্ব তরঙ্গ শব্দের বেগে চলে" } },
        { "id": "opt-3", "text": { "en": "Because reflection is always 100% for TE waves", "hi": "क्योंकि TE तरंगों का परावर्तन सदैव 100% होता है", "bn": "কারণ TE তরঙ্গের প্রতিফলন সর্বদা ১০০% হয়" } },
        { "id": "opt-4", "text": { "en": "Because Snell's law does not apply to TE waves", "hi": "क्योंकि स्नेल का नियम TE पर लागू नहीं होता", "bn": "কারণ স্নেলের সূত্র TE তরঙ্গে খাটে না" } }
      ],
    ...
    },
    {
      ...
      "options": [
        { "id": "opt-1", "text": { "en": "Parallel to the plane of incidence", "hi": "आपतन तल के समानांतर", "bn": "আপাতন তলের সমান্তরালে" } },
        { "id": "opt-2", "text": { "en": "Perpendicular to the plane of incidence", "hi": "आपतन तल के लंबवत", "bn": "আপাতন তলের সাথে লম্বভাবে" } },
        { "id": "opt-3", "text": { "en": "Parallel to the propagation direction k", "hi": "संचरण दिशा k के समानांतर", "bn": "গতির অভিমুখ k এর সমান্তরালে" } },
        { "id": "opt-4", "text": { "en": "Rotating in a circle", "hi": "एक वृत्त में घूर्णन करता हुआ", "bn": "বৃত্তাকার পথে ঘূর্ণায়মান" } }
      ],
      "correctOptionId": "opt-2",
      "explanation": {
...
save_lesson('src/data/chapter11Lesson10.ts', 'LESSON_OBLIQUE_INCIDENCE_SNELL_BREWSTER', lesson10)
print("Lesson 10 generated.")
