  ...
  "formulas": [
    {
      ...
      "variables": [
        { "symbol": "f_c,mn", "name": { "en": "Cutoff frequency for mode (m, n) (Hz)", "hi": "मोड (m, n) की अंतक आवृत्ति", "bn": "মোড (m, n) এর কাটঅফ কম্পাঙ্ক" } },
        { "symbol": "a", "name": { "en": "Broad wall internal width (m)", "hi": "चौड़ी दीवार की आंतरिक चौड़ाई", "bn": "প্রশস্ত দেয়ালের অভ্যন্তরীণ প্রস্থ" } },
        { "symbol": "b", "name": { "en": "Narrow wall internal height (m)", "hi": "संकीर्ण दीवार की आंतरिक ऊंचाई", "bn": "সংকীর্ণ দেয়ালের অভ্যন্তরীণ উচ্চতা" } },
        { "symbol": "m, n", "name": { "en": "Mode indices (integers: 0, 1, 2...)", "hi": "विधा सूचकांक (m, n)", "bn": "মোড সূচক (m, n)" } }
      ]
    },
    {
      ...
      "variables": [
        { "symbol": "f_c,10", "name": { "en": "Dominant TE10 cutoff frequency (Hz)", "hi": "प्रमुख TE10 अंतक आवृत्ति", "bn": "প্রধান TE10 কাটঅফ কম্পাঙ্ক" } },
        { "symbol": "λ_c,10", "name": { "en": "Dominant mode cutoff wavelength (m)", "hi": "अंतक तरंगदैर्ध्य", "bn": "কাটঅফ তরঙ্গদৈর্ঘ্য" } }
      ]
    },
    {
      ...
      "variables": [
        { "symbol": "λ_g", "name": { "en": "Guide wavelength (m)", "hi": "गाइड तरंगदैर्ध्य", "bn": "গাইড তরঙ্গদৈর্ঘ্য" } },
        { "symbol": "λ0", "name": { "en": "Unbounded medium wavelength (c/f) (m)", "hi": "मुक्त माध्यम तरंगदैर्ध्य", "bn": "মুক্ত মাধ্যমের তরঙ্গদৈর্ঘ্য" } }
      ]
    },
    {
      ...
      "variables": [
        { "symbol": "v_p", "name": { "en": "Phase velocity (m/s, > c)", "hi": "कला वेग", "bn": "দশা বেগ" } },
        { "symbol": "v_g", "name": { "en": "Group velocity (m/s, < c)", "hi": "समूह वेग", "bn": "দলগত বেগ" } }
      ]
    }
  ],
  "sections": [
  ...
  "mcqs": [
    {
      ...
      "options": [
        { "id": "opt-1", "text": { "en": "Because it has only one single continuous conducting boundary", "hi": "क्योंकि इसमें केवल एक ही सतत चालक सीमा होती है", "bn": "কারণ এতে কেবল একটি একক নিরবচ্ছিন্ন পরিবাহী সীমানা থাকে" } },
        { "id": "opt-2", "text": { "en": "Because it is made of metal instead of plastic", "hi": "क्योंकि यह प्लास्टिक के बजाय धातु की बनी होती है", "bn": "কারণ এটি প্লাস্টিকের বদলে ধাতু দিয়ে তৈরি" } },
        { "id": "opt-3", "text": { "en": "Because TEM waves only exist in vacuum", "hi": "क्योंकि TEM तरंगें केवल निर्वात में होती हैं", "bn": "কারণ TEM তরঙ্গ কেবল শূন্যস্থানে থাকে" } },
        { "id": "opt-4", "text": { "en": "Because the frequency is too high", "hi": "क्योंकि आवृत्ति बहुत अधिक होती है", "bn": "কারণ কম্পাঙ্ক অত্যন্ত বেশি" } }
      ],
    ...
    },
    {
      ...
      "options": [
        { "id": "opt-1", "text": { "en": "TM01", "hi": "TM01", "bn": "TM01" } },
        { "id": "opt-2", "text": { "en": "TE10", "hi": "TE10", "bn": "TE10" } },
        { "id": "opt-3", "text": { "en": "TE01", "hi": "TE01", "bn": "TE01" } },
        { "id": "opt-4", "text": { "en": "TM11", "hi": "TM11", "bn": "TM11" } }
      ],
    ...
    },
    {
      ...
      "options": [
        { "id": "opt-1", "text": { "en": "The wave travels faster than the speed of light with zero loss", "hi": "तरंग बिना किसी हानि के प्रकाश से तेज गति से चलती है", "bn": "তরঙ্গ কোনো অপচয় ছাড়াই আলোর চেয়ে দ্রুত গতিতে চলবে" } },
        { "id": "opt-2", "text": { "en": "The wave is evanescent and attenuates exponentially down the tube without propagating power", "hi": "तरंग अवमंदित हो जाती है और बिना शक्ति संचरित किए चरघातांकी रूप से नष्ट हो जाती है", "bn": "তরঙ্গটি ক্ষীয়মাণ হয়ে যায় এবং শক্তি সঞ্চালন না করে সূচকীয় হারে নিঃশেষ হয়" } },
        { "id": "opt-3", "text": { "en": "The wave converts permanently into sound waves", "hi": "तरंग ध्वनि तरंगों में बदल जाती है", "bn": "তরঙ্গটি শব্দ তরঙ্গে রূপান্তরিত হয়" } },
        { "id": "opt-4", "text": { "en": "The wave reflects back with increased frequency", "hi": "तरंग बढ़ी हुई आवृत्ति के साथ वापस लौटती है", "bn": "তরঙ্গটি বর্ধিত কম্পাঙ্ক নিয়ে ফিরে আসে" } }
      ],
      "correctOptionId": "opt-2",
      "explanation": {
    ...
    },
    {
      ...
      "options": [
        { "id": "opt-1", "text": { "en": "1.5 cm", "hi": "1.5 cm", "bn": "১.৫ সেমি" } },
        { "id": "opt-2", "text": { "en": "3.0 cm", "hi": "3.0 cm", "bn": "৩.০ সেমি" } },
        { "id": "opt-3", "text": { "en": "6.0 cm", "hi": "6.0 cm", "bn": "৬.০ সেমি" } },
        { "id": "opt-4", "text": { "en": "12.0 cm", "hi": "12.0 cm", "bn": "১২.০ সেমি" } }
      ],
    ...
    },
    {
      ...
      "options": [
        ...
        { "id": "opt-2", "text": { "en": "c (speed of light)", "hi": "c (प्रकाश की गति)", "bn": "c (আলোর বেগ)" } },
        { "id": "opt-3", "text": { "en": "c² (speed of light squared)", "hi": "c² (प्रकाश की गति का वर्ग)", "bn": "c² (আলোর বেগের বর্গ)" } },
    ...
    },
    {
      ...
      "options": [
        { "id": "opt-1", "text": { "en": "Because boundary conditions force E_z to be zero everywhere if either m = 0 or n = 0", "hi": "क्योंकि यदि m = 0 या n = 0 हो तो सीमा शर्तें E_z को पूरे क्षेत्र में शून्य कर देती हैं", "bn": "কারণ m = ০ বা n = ০ হলে সীমানা শর্ত E_z কে সব জায়গায় শূন্য করে দেয়" } },
        { "id": "opt-2", "text": { "en": "Because magnetic fields cannot enter copper", "hi": "क्योंकि चुंबकीय क्षेत्र तांबे में प्रवेश नहीं कर सकता", "bn": "কারণ চৌম্বক ক্ষেত্র তামায় প্রবেশ করতে পারে না" } },
        { "id": "opt-3", "text": { "en": "Because TM modes only exist in coaxial cables", "hi": "क्योंकि TM विधाएं केवल कोएक्सियल केबल में होती हैं", "bn": "কারণ TM মোড কেবল কোঅ্যাক্সিয়ালে থাকে" } },
        { "id": "opt-4", "text": { "en": "Because cutoff frequency would be negative", "hi": "क्योंकि अंतक आवृत्ति ऋणात्मक हो जाएगी", "bn": "কারণ কাটঅফ কম্পাঙ্ক ঋণাত্মক হবে" } }
      ],
      "correctOptionId": "opt-1",
      "explanation": {
    ...
    },
    {
      ...
      "options": [
        { "id": "opt-1", "text": { "en": "λ_g is always shorter than λ0 (λ_g < λ0)", "hi": "λ_g सदैव λ0 से छोटी होती है", "bn": "λ_g সর্বদা λ0 এর চেয়ে ছোট হয়" } },
        { "id": "opt-2", "text": { "en": "λ_g is always longer than λ0 (λ_g > λ0)", "hi": "λ_g सदैव λ0 से बड़ी होती है (λ_g > λ0)", "bn": "λ_g সর্বদা λ0 এর চেয়ে বড় হয় (λ_g > λ0)" } },
        { "id": "opt-3", "text": { "en": "λ_g is exactly equal to λ0", "hi": "λ_g सदैव λ0 के बराबर होती है", "bn": "λ_g সর্বদা λ0 এর সমান" } },
        { "id": "opt-4", "text": { "en": "λ_g is zero", "hi": "λ_g शून्य होती है", "bn": "λ_g শূন্য" } }
      ],
      "correctOptionId": "opt-2",
      "explanation": {
    ...
    },
    {
      ...
      "options": [
        { "id": "opt-1", "text": { "en": "0.500 c", "hi": "0.500 c", "bn": "০.৫০০ c" } },
        { "id": "opt-2", "text": { "en": "0.866 c", "hi": "0.866 c", "bn": "০.৮৬৬ c" } },
        { "id": "opt-3", "text": { "en": "1.155 c", "hi": "1.155 c", "bn": "১.১৫৫ c" } },
        { "id": "opt-4", "text": { "en": "c", "hi": "c", "bn": "c" } }
      ],
      "correctOptionId": "opt-2",
      "explanation": {
...
save_lesson('src/data/chapter11Lesson12.ts', 'LESSON_WAVEGUIDES_CUTOFF_DISPERSION', lesson12)
print("Lesson 12 generated.")
