...
export const LESSON_ANTENNA_FUNDAMENTALS_LINK_BUDGET: Lesson = {
      ...
      "variables": [
        {
          "symbol": "R_ff",
          "name": {
            "en": "Far-field Fraunhofer boundary distance (m)",
            "hi": "सुदूर-क्षेत्र सीमा दूरी",
            "bn": "দূর-ক্ষেত্র দূরত্ব"
          }
        },
        {
          "symbol": "D",
          "name": {
            "en": "Maximum linear dimension of antenna aperture (m)",
            "hi": "एंटीना का अधिकतम रैखिक आकार",
            "bn": "অ্যান্টেনার সর্বোচ্চ রৈখিক মাপ"
          }
        },
        {
          "symbol": "λ",
          "name": {
            "en": "Carrier wavelength (m)",
            "hi": "तरंगदैर्ध्य",
            "bn": "তরঙ্গদৈর্ঘ্য"
          }
        }
      ...
      "variables": [
        {
          "symbol": "R_rad",
          "name": {
            "en": "Radiation resistance (73.1 Ω for λ/2 dipole)",
            "hi": "विकिरण प्रतिरोध (Ω)",
            "bn": "বিকিরণ রোধ (Ω)"
          }
        },
        {
          "symbol": "P_rad",
          "name": {
            "en": "Total time-averaged radiated power (Watts)",
            "hi": "कुल विकिरित शक्ति",
            "bn": "মোট বিকিরিত ক্ষমতা"
          }
        },
        {
          "symbol": "I_0",
          "name": {
            "en": "Peak feed-point input current (Amperes)",
            "hi": "शिखर इनपुट करंट",
            "bn": "শীর্ষ ইনপুট কারেন্ট"
          }
        }
      ]
    },
      ...
      "variables": [
        {
          "symbol": "A_e",
          "name": {
            "en": "Effective aperture (m²)",
            "hi": "प्रभावी द्वारक",
            "bn": "কার্যকর অ্যাপারচার"
          }
        },
        {
          "symbol": "G",
          "name": {
            "en": "Antenna power gain (dimensionless)",
            "hi": "एंटीना लब्धि",
            "bn": "অ্যান্টেনা গেইন"
          }
        },
    ...
    },
    {
      ...
      "variables": [
        ...
        },
        {
          "symbol": "G_t, G_r",
          "name": {
            "en": "Transmitter & receiver antenna gains",
            "hi": "ट्रांसमीटर एवं रिसीवर एंटीना गैन",
            "bn": "ট্রান্সমিটার ও রিসিভারের অ্যান্টেনা গেইন"
          }
        },
        {
          "symbol": "R",
          "name": {
            "en": "Separation distance between antennas (m)",
            "hi": "दूरी",
            "bn": "দূরত্ব"
          }
        }
      ...
      "options": [
        {
          "id": "opt-1",
          "text": {
            "en": "A stationary charge at rest",
            "hi": "विरामावस्था में स्थित स्थिर आवेश",
            "bn": "স্থির অবস্থায় থাকা আধান"
          }
        },
        {
          "id": "opt-2",
          "text": {
            "en": "A charge moving at constant uniform linear velocity",
            "hi": "एकसमान वेग से गतिमान आवेश",
            "bn": "সমবেগে চলমান আধান"
          }
        },
        {
          "id": "opt-3",
          "text": {
            "en": "An accelerating or oscillating charge",
            "hi": "त्वरित अथवा दोलनशील आवेश",
            "bn": "ত্বরণশীল বা স্পন্দনশীল আধান"
          }
        },
        {
          "id": "opt-4",
          "text": {
            "en": "A charge placed inside a battery",
            "hi": "बैटरी के अंदर रखा आवेश",
            "bn": "ব্যাটারির ভেতরে থাকা চার্জ"
          }
        }
      ],
      ...
      "options": [
        {
          "id": "opt-1",
          "text": {
            "en": "A narrow pencil beam pointing straight up",
            "hi": "सीधे ऊपर की ओर केंद्रित एक संकीर्ण बीम",
            "bn": "সোজা ওপরের দিকে নির্দেশিত সরু পেনসিল বিম"
          }
        },
        {
          "id": "opt-2",
          "text": {
            "en": "A doughnut (torus) with zero radiation along the wire axis",
            "hi": "डोनट (टोरस) आकार, जिसमें तार के अक्ष के अनुदिश शून्य विकिरण होता है",
            "bn": "একটি ডোনাট (টোরাস), যার তারের অক্ষ বরাবর বিকিরণ শূন্য থাকে"
          }
        },
        {
          "id": "opt-3",
          "text": {
            "en": "A perfect isotropic sphere radiating equally in all directions",
            "hi": "सभी दिशाओं में समान रूप से विकिरित होने वाला एक गोला",
            "bn": "সবদিকে সমান বিকিরণকারী একটি নিখুঁত গোলক"
          }
        },
        {
          "id": "opt-4",
          "text": {
            "en": "A cube with six equal faces",
            "hi": "छह फलकों वाला एक घन",
            "bn": "ছয়টি তলবিশিষ্ট একটি ঘনক"
          }
        }
      ],
      "correctOptionId": "opt-2",
      ...
      "options": [
        {
          "id": "opt-1",
          "text": {
            "en": "Decreases by half (-3 dB)",
            "hi": "आधा घट जाती है (-3 dB)",
            "bn": "অর্ধেক হ্রাস পায় (-৩ dB)"
          }
        },
        {
          "id": "opt-2",
          "text": {
            "en": "Decreases to one-fourth (-6 dB)",
            "hi": "एक-चौथाई रह जाती है (-6 dB)",
            "bn": "এক-চতুর্থাংশ হয়ে যায় (-৬ dB)"
          }
        },
        {
          "id": "opt-3",
          "text": {
            "en": "Doubles (+3 dB)",
            "hi": "दोगुनी हो जाती है (+3 dB)",
            "bn": "দ্বিগুণ বৃদ্ধি পায় (+৩ dB)"
          }
        },
        {
          "id": "opt-4",
      ...
      "options": [
        {
          "id": "opt-1",
          "text": {
            "en": "The link has failed completely and cannot communicate",
            "hi": "लिंक पूरी तरह विफल हो गया है और संपर्क नहीं हो सकता",
            "bn": "লিংকটি সম্পূর্ণ ব্যর্থ হয়েছে এবং যোগাযোগ সম্ভব নয়"
          }
        },
        {
          "id": "opt-2",
          "text": {
            "en": "The received signal is 15 dB stronger than the minimum required receiver sensitivity, ensuring reliable connection despite fading",
            "hi": "प्राप्त सिग्नल आवश्यक न्यूनतम संवेदनशीलता से 15 dB अधिक मजबूत है, जो सिग्नल उतार-चढ़ाव में भी स्थिर संपर्क सुनिश्चित करता है",
            "bn": "গৃহীত সংকেত রিসিভারের ন্যূনতম সংবেদনশীলতার চেয়ে ১৫ dB শক্তিশালী, যা ফেডিং সত্ত্বেও স্থিতিশীল যোগাযোগ নিশ্চিত করে"
          }
        },
        {
          "id": "opt-3",
          "text": {
            "en": "The transmitter is overheating by 15 degrees Celsius",
            "hi": "ट्रांसमीटर 15 डिग्री सेल्सियस अधिक गर्म हो रहा है",
            "bn": "ট্রান্সমিটার ১৫ ডিগ্রি সেলসিয়াস অতিরিক্ত উত্তপ্ত হচ্ছে"
          }
        },
        {
          "id": "opt-4",
          "text": {
            "en": "The antenna has rotated by 15 degrees",
            "hi": "एंटीना 15 डिग्री घूम गया है",
            "bn": "অ্যান্টেনা ১৫ ডিগ্রি ঘুরে গেছে"
          }
        }
      ],
      "correctOptionId": "opt-2",
