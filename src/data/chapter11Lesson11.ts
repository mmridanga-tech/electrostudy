...
export const LESSON_SKIN_DEPTH_CONDUCTORS_SHIELDING: Lesson = {
  ...
  "formulas": [
    {
      ...
      "variables": [
        ...
        },
        {
          "symbol": "μ",
          "name": {
            "en": "Magnetic permeability (H/m, μ = μr μ0)",
            "hi": "चुंबकशीलता (H/m)",
            "bn": "চৌম্বক প্রবেশ্যতা (H/m)"
          }
        }
      ]
    },
      ...
      "variables": [
        {
          "symbol": "A_dB",
          "name": {
            "en": "Absorption loss in decibels (dB)",
            "hi": "अवशोषण हानि (dB)",
            "bn": "শোষণ অপচয় (dB)"
          }
        },
        {
          "symbol": "t",
          "name": {
            "en": "Shield thickness (m)",
            "hi": "परिरक्षक की मोटाई (m)",
            "bn": "শিল্ডের পুরুত্ব (m)"
          }
        }
      ]
    }
      ...
      "options": [
        {
          "id": "opt-1",
          "text": {
            "en": "Proportional to f (δ ∝ f)",
            "hi": "f के समानुपाती (δ ∝ f)",
            "bn": "f এর সমানুপাতিক (δ ∝ f)"
          }
        },
        {
          "id": "opt-2",
          "text": {
            "en": "Inversely proportional to the square root of f (δ ∝ 1/√f)",
            "hi": "f के वर्गमूल के व्युत्क्रमानुपाती (δ ∝ 1/√f)",
            "bn": "f এর বর্গমূলের ব্যস্তানুপাতিক (δ ∝ ১/√f)"
          }
        },
        {
          "id": "opt-3",
          "text": {
            "en": "Proportional to f²",
            "hi": "f² के समानुपाती",
            "bn": "f² এর সমানুপাতিক"
          }
        },
        {
          "id": "opt-4",
          "text": {
            "en": "Independent of frequency",
            "hi": "आवृत्ति से स्वतंत्र",
            "bn": "কম্পাঙ্কের ওপর নির্ভরশীল নয়"
          }
        }
      ],
      ...
      "options": [
        {
          "id": "opt-1",
          "text": {
            "en": "Because iron has much higher magnetic permeability (μ = μr μ0, where μr ≫ 1)",
            "hi": "क्योंकि लोहे की चुंबकशीलता बहुत अधिक होती है (μr ≫ 1)",
            "bn": "কারণ লোহার চৌম্বক প্রবেশ্যতা অনেক বেশি (μr ≫ ১)"
          }
        },
        {
          "id": "opt-2",
          "text": {
            "en": "Because iron has higher conductivity than copper",
            "hi": "क्योंकि लोहे की चालकता तांबे से अधिक होती है",
            "bn": "কারণ লোহার পরিবাহিতা তামার চেয়ে বেশি"
          }
        },
        {
          "id": "opt-3",
          "text": {
            "en": "Because iron is heavier than copper",
            "hi": "क्योंकि लोहा तांबे से भारी होता है",
            "bn": "কারণ লোহা তামার চেয়ে ভারী"
          }
        },
        {
          "id": "opt-4",
          "text": {
            "en": "Because iron has a lower melting point",
            "hi": "क्योंकि लोहे का गलनांक कम होता है",
            "bn": "কারণ লোহার গলনাঙ্ক কম"
          }
        }
      ],
      ...
      "options": [
        {
          "id": "opt-1",
          "text": {
            "en": "R_ac increases linearly with f",
            "hi": "R_ac आवृत्ति f के रैखिक समानुपाती होता है",
            "bn": "R_ac কম্পাঙ্ক f এর সাথে রৈখিকভাবে বাড়ে"
          }
        },
        {
          "id": "opt-2",
          "text": {
            "en": "R_ac increases proportional to √f",
            "hi": "R_ac आवृत्ति के वर्गमूल (√f) के समानुपाती बढ़ता है",
            "bn": "R_ac কম্পাঙ্কের বর্গমূলের (√f) সমানুপাতিক হারে বাড়ে"
          }
        },
        {
          "id": "opt-3",
          "text": {
            "en": "R_ac remains constant",
            "hi": "R_ac स्थिर रहता है",
            "bn": "R_ac ধ্রুবক থাকে"
          }
        },
        {
          "id": "opt-4",
          "text": {
            "en": "R_ac decreases as 1/√f",
            "hi": "R_ac घटकर 1/√f हो जाता है",
            "bn": "R_ac কমে ১/√f হয়"
          }
        }
      ],
      ...
      "options": [
        {
          "id": "opt-1",
          "text": {
            "en": "To mitigate skin effect and reduce AC resistance by increasing total effective surface area",
            "hi": "स्किन प्रभाव को कम करने और कुल प्रभावी सतह क्षेत्र बढ़ाकर AC प्रतिरोध घटाने के लिए",
            "bn": "স্কিন ইফেক্ট কমিয়ে মোট পৃষ্ঠের ক্ষেত্রফল বৃদ্ধি করে AC রোধ হ্রাস করার জন্য"
          }
        },
        {
          "id": "opt-2",
          "text": {
            "en": "To increase wire capacitance",
            "hi": "तार की धारिता बढ़ाने के लिए",
            "bn": "তারের ধারকত্ব বৃদ্ধি করতে"
          }
        },
        {
          "id": "opt-3",
          "text": {
            "en": "To make the wire physically heavier",
            "hi": "तार को भारी बनाने के लिए",
            "bn": "তারকে ভারী করতে"
          }
        },
        {
          "id": "opt-4",
          "text": {
            "en": "To prevent oxidation at room temperature",
            "hi": "कमरे के तापमान पर ऑक्सीकरण रोकने के लिए",
            "bn": "স্বাভাবিক তাপমাত্রায় জারণ রোধ করতে"
          }
        }
      ],
      "correctOptionId": "opt-1",
    ...
    },
    {
      ...
      "options": [
        ...
        },
        {
          "id": "opt-2",
          "text": {
            "en": "X_s = R_s (inductive reactance equal to resistance)",
            "hi": "X_s = R_s (प्रतिरोध के बराबर प्रेरकीय प्रतिघात)",
            "bn": "X_s = R_s (রোধের সমান আবেশীয় রিঅ্যাকট্যান্স)"
          }
        },
        {
          "id": "opt-3",
          "text": {
            "en": "X_s = -R_s (capacitive reactance)",
            "hi": "X_s = -R_s (धारितीय प्रतिघात)",
            "bn": "X_s = -R_s (ধারকীয় রিঅ্যাকট্যান্স)"
          }
        },
        {
          "id": "opt-4",
