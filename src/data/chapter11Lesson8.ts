...
export const LESSON_WAVE_POLARIZATION: Lesson = {
      ...
      "variables": [
        {
          "symbol": "E_0x",
          "name": {
            "en": "Peak x-component amplitude (V/m)",
            "hi": "x-घटक का शिखर आयाम",
            "bn": "x-উপাংশের শীর্ষ বিস্তার"
          }
        },
        {
          "symbol": "E_0y",
          "name": {
            "en": "Peak y-component amplitude (V/m)",
            "hi": "y-घटक का शिखर आयाम",
            "bn": "y-উপাংশের শীর্ষ বিস্তার"
          }
        },
        {
          "symbol": "δ",
          "name": {
            "en": "Phase difference δ = φ_y - φ_x (radians)",
            "hi": "कलान्तर (रेडियन)",
            "bn": "দশা পার্থক্য (রেডিয়ান)"
          }
        },
        {
          "symbol": "β",
          "name": {
            "en": "Phase constant β = 2π / λ (rad/m)",
            "hi": "कला नियतांक",
            "bn": "দশা ধ্রুবক"
          }
        }
      ...
      "variables": [
        {
          "symbol": "AR",
          "name": {
            "en": "Axial ratio (dimensionless, ≥ 1)",
            "hi": "अक्षीय अनुपात",
            "bn": "অক্ষীয় অনুপাত"
          }
        },
        {
          "symbol": "OA",
          "name": {
            "en": "Length of semi-major axis",
            "hi": "दीर्घ अर्ध-अक्ष की लंबाई",
            "bn": "অর্ধ-মুখ্য অক্ষের দৈর্ঘ্য"
          }
        },
        {
          "symbol": "OB",
          "name": {
            "en": "Length of semi-minor axis",
            "hi": "लघु अर्ध-अक्ष की लंबाई",
            "bn": "অর্ধ-গৌণ অক্ষের দৈর্ঘ্য"
          }
        }
      ]
    },
      ...
      "variables": [
        {
          "symbol": "ψ",
          "name": {
            "en": "Tilt angle (degrees or radians)",
            "hi": "झुकाव कोण",
            "bn": "নতি কোণ"
          }
        }
      ...
      "variables": [
        {
          "symbol": "PLF",
          "name": {
            "en": "Power transfer ratio (0 to 1)",
            "hi": "शक्ति स्थानांतरण अनुपात",
            "bn": "ক্ষমতা সঞ্চালন অনুপাত"
          }
        },
        {
          "symbol": "e_w",
          "name": {
            "en": "Unit polarization vector of incoming wave",
            "hi": "तरंग का एकांक ध्रुवीकरण सदिश",
            "bn": "তরঙ্গের একক সমবর্তন ভেক্টর"
          }
        },
        {
          "symbol": "e_a",
          "name": {
            "en": "Unit polarization vector of receiving antenna",
            "hi": "एंटीना का एकांक ध्रुवीकरण सदिश",
            "bn": "অ্যান্টেনার একক সমবর্তন ভেক্টর"
          }
        }
      ]
    }
      ...
      "options": [
        {
          "id": "opt-1",
          "text": {
            "en": "Equal orthogonal amplitudes and 0° phase difference",
            "hi": "समान लंबवत आयाम और 0° कलान्तर",
            "bn": "সমান লম্ব বিস্তার এবং ০° দশা পার্থক্য"
          }
        },
        {
          "id": "opt-2",
          "text": {
            "en": "Equal orthogonal amplitudes and 90° (π/2) phase difference",
            "hi": "समान लंबवत आयाम और 90° (π/2) कलान्तर",
            "bn": "সমান লম্ব বিস্তার এবং ৯০° (π/২) দশা পার্থক্য"
          }
        },
        {
          "id": "opt-3",
          "text": {
            "en": "Unequal orthogonal amplitudes and 90° phase difference",
            "hi": "असमान लंबवत आयाम और 90° कलान्तर",
            "bn": "অসমান লম্ব বিস্তার এবং ৯০° দশা পার্থক্য"
          }
        },
        {
          "id": "opt-4",
          "text": {
            "en": "Equal amplitudes and 180° phase difference",
            "hi": "समान आयाम और 180° कलान्तर",
            "bn": "সমান বিস্তার এবং ১৮০° দশা পার্থক্য"
          }
        }
      ],
      ...
      "options": [
        {
          "id": "opt-1",
          "text": {
            "en": "Right-hand circular",
            "hi": "दक्षिणावर्त वृत्तीय",
            "bn": "ডানহাতি বৃত্তীয়"
          }
        },
        {
        ...
        },
        {
          "id": "opt-3",
          "text": {
            "en": "Linear, oriented at -45° to the x-axis",
            "hi": "रेखीय, x-अक्ष से -45° पर स्थित",
            "bn": "রৈখিক, x-অক্ষের সাথে -৪৫° কোণে"
          }
        },
        {
          "id": "opt-4",
      ...
      "options": [
        {
          "id": "opt-1",
          "text": {
            "en": "100% of incident power",
            "hi": "आपतित शक्ति का 100%",
            "bn": "আপতিত ক্ষমতার ১০০%"
          }
        },
        {
          "id": "opt-2",
        ...
        },
        {
          "id": "opt-3",
          "text": {
            "en": "0% (infinite cross-polarization loss)",
            "hi": "0% (अनंत क्रॉस-ध्रुवीकरण हानि)",
            "bn": "০% (সম্পূর্ণ বিচ্ছিন্নতা)"
          }
        },
        {
          "id": "opt-4",
      ...
      "options": [
        {
          "id": "opt-1",
          "text": {
            "en": "Circular waves travel faster through space than linear waves",
            "hi": "वृत्तीय तरंगें अंतरिक्ष में रेखीय तरंगों से तेज चलती हैं",
            "bn": "বৃত্তীয় তরঙ্গ মহাশূন্যে রৈখিক তরঙ্গের চেয়ে দ্রুত চলে"
          }
        },
        {
          "id": "opt-2",
          "text": {
            "en": "To overcome ionospheric Faraday rotation and avoid receiver orientation dependency",
            "hi": "आयनमंडलीय फैराडे घूर्णन को निष्प्रभावी करने तथा रिसीवर अभिविन्यास पर निर्भरता समाप्त करने हेतु",
            "bn": "আয়নমণ্ডলের ফ্যারাডে ঘূর্ণন দূর করতে এবং রিসিভারের কোণ পরিবর্তনের প্রভাব এড়াতে"
          }
        },
        {
          "id": "opt-3",
          "text": {
            "en": "Circular waves have zero attenuation in rain",
            "hi": "बारिश में वृत्तीय तरंगों का क्षीणन शून्य होता है",
            "bn": "বৃষ্টিতে বৃত্তীয় তরঙ্গের কোনো ক্ষয় হয় না"
          }
        },
        {
          "id": "opt-4",
          "text": {
            "en": "To reduce satellite transmitter power by 90%",
            "hi": "उपग्रह ट्रांसमीटर शक्ति को 90% घटाने के लिए",
            "bn": "স্যাটেলাইটের শক্তি ৯০% কমাতে"
          }
        }
      ],
      "correctOptionId": "opt-2",
      ...
      "options": [
        {
          ...
          "text": {
            "en": "0 dB (no loss)",
            "hi": "0 dB (कोई हानि नहीं)",
            "bn": "০ dB (কোনো অপচয় নেই)"
          }
        },
        {
          "id": "opt-2",
          "text": {
            "en": "3.01 dB (half power)",
            "hi": "3.01 dB (आधी शक्ति)",
            "bn": "৩.০১ dB (অর্ধেক ক্ষমতা)"
          }
        },
        {
          "id": "opt-3",
          "text": {
            "en": "6.02 dB (quarter power)",
            "hi": "6.02 dB (चौथाई शक्ति)",
            "bn": "৬.০২ dB (এক-চতুর্থাংশ ক্ষমতা)"
          }
        },
        {
          "id": "opt-4",
          "text": {
            "en": "Infinite dB (total loss)",
            "hi": "अनंत dB (पूर्ण हानि)",
            "bn": "অসীম dB (সম্পূর্ণ অপচয়)"
          }
        }
      ],
      "correctOptionId": "opt-2",
      ...
      "options": [
        {
          "id": "opt-1",
          "text": {
            "en": "Circularly polarized",
            "hi": "वृत्तीय ध्रुवीकृत",
            "bn": "বৃত্তীয় সমবর্তিত"
          }
        },
        {
          "id": "opt-2",
          "text": {
            "en": "Linearly polarized",
            "hi": "रेखीय ध्रुवीकृत",
            "bn": "রৈখিক সমবর্তিত"
          }
        },
        {
          "id": "opt-3",
          "text": {
            "en": "Elliptically polarized with major axis along x",
            "hi": "दीर्घवृत्तीय ध्रुवीकृत जिसका मुख्य अक्ष x के अनुदिश है",
            "bn": "উপবৃত্তীয় সমবর্তিত যার মুখ্য অক্ষ x বরাবর"
          }
        },
        {
          "id": "opt-4",
      ...
      "options": [
        {
          "id": "opt-1",
          "text": {
            "en": "100% Circularly polarized",
            "hi": "100% वृत्तीय ध्रुवीकृत",
            "bn": "১০০% বৃত্তীয় সমবর্তিত"
          }
        },
        {
          "id": "opt-2",
          "text": {
            "en": "100% Linearly polarized perpendicular to the plane of incidence",
            "hi": "आपतन तल के लंबवत 100% रेखीय ध्रुवीकृत",
            "bn": "আপাতন তলের সাথে লম্বভাবে ১০০% রৈখিক সমবর্তিত"
          }
        },
        {
          "id": "opt-3",
          "text": {
            "en": "100% Linearly polarized parallel to the plane of incidence",
            "hi": "आपतन तल के समानांतर 100% रेखीय ध्रुवीकृत",
            "bn": "আপাতন তলের সমান্তরালে ১০০% রৈখিক সমবর্তিত"
          }
        },
        {
          "id": "opt-4",
          "text": {
            "en": "Completely unpolarized",
            "hi": "पूर्णतः अध्रुवीकृत",
            "bn": "সম্পূর্ণ অসমবর্তিত"
          }
        }
      ],
      "correctOptionId": "opt-2",
