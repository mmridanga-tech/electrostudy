...
export const LESSON_NORMAL_INCIDENCE_REFLECTION: Lesson = {
      ...
      "variables": [
        {
          "symbol": "Γ",
          "name": {
            "en": "Reflection coefficient (dimensionless)",
            "hi": "परावर्तन गुणांक",
            "bn": "প্রতিফলন গুণাঙ্ক"
          }
        },
        {
          "symbol": "η1",
          "name": {
            "en": "Intrinsic impedance of Medium 1 (Ω)",
            "hi": "माध्यम 1 की प्रतिबाधा (Ω)",
            "bn": "১ম মাধ্যমের প্রতিবন্ধকতা (Ω)"
          }
        },
        {
          "symbol": "η2",
          "name": {
            "en": "Intrinsic impedance of Medium 2 (Ω)",
            "hi": "माध्यम 2 की प्रतिबाधा (Ω)",
            "bn": "২য় মাধ্যমের প্রতিবন্ধকতা (Ω)"
          }
        }
      ]
    },
      ...
      "variables": [
        {
          "symbol": "τ",
          "name": {
            "en": "Transmission coefficient (dimensionless)",
            "hi": "पारगमन गुणांक",
            "bn": "সঞ্চালন গুণাঙ্ক"
          }
        }
      ...
      "variables": [
        {
          "symbol": "SWR",
          "name": {
            "en": "Standing wave ratio (dimensionless, ≥ 1)",
            "hi": "स्थायी तरंग अनुपात",
            "bn": "স্থির তরঙ্গ অনুপাত"
          }
        },
        {
          "symbol": "|Γ|",
          "name": {
            "en": "Magnitude of reflection coefficient",
            "hi": "परावर्तन गुणांक का परिमाण",
            "bn": "প্রতিফলন গুণাঙ্কের মান"
          }
        }
      ]
    },
      ...
      "variables": [
        {
          "symbol": "η_coat",
          "name": {
            "en": "Intrinsic impedance of coating layer (Ω)",
            "hi": "कोटिंग परत की प्रतिबाधा",
            "bn": "আবরণ স্তরের প্রতিবন্ধকতা"
          }
        },
        {
          "symbol": "d",
          "name": {
            "en": "Physical thickness of coating layer (m)",
            "hi": "कोटिंग की मोटाई",
            "bn": "আবরণের পুরুত্ব"
          }
        }
  ...
  "mcqs": [
    {
      ...
      "options": [
        ...
        },
        {
          "id": "opt-2",
          "text": {
            "en": "+1.0 (in-phase reflection)",
            "hi": "+1.0 (समान कला परावर्तन)",
            "bn": "+১.০ (সমদশা প্রতিফলন)"
          }
        },
        {
          "id": "opt-3",
          "text": {
            "en": "-1.0 (180° out-of-phase reflection)",
            "hi": "-1.0 (180° विपरीत कला परावर्तन)",
            "bn": "-১.০ (১৮০° বিপরীত দশা প্রতিফলন)"
          }
        },
        {
          "id": "opt-4",
      ...
      "options": [
        {
          "id": "opt-1",
          "text": {
            "en": "At z = -m λ/4 (for odd m)",
            "hi": "z = -m λ/4 पर (विषम m के लिए)",
            "bn": "z = -m λ/৪ এ (বিজোড় m এর জন্য)"
          }
        },
        {
          "id": "opt-2",
          "text": {
            "en": "At z = -m λ/2 (for integer m = 0, 1, 2...)",
            "hi": "z = -m λ/2 पर (पूर्णांक m = 0, 1, 2...)",
            "bn": "z = -m λ/২ এ (পূর্ণসংখ্যা m = ০, ১, ২...)"
          }
        },
        {
          "id": "opt-3",
